...
export default function EventDialog() {
  ...
  const { cart, setCart, event, setEvent, setError } = useContext(Context);
        ...
        <DialogActions>
          ...
          >
            ...
            <div>
              ...
              />
              <Chip
                label={`${event?.details[3].sectionContent}`}
                variant="outlined"
            ...
            <Button
              ...
              variant="outlined"
              onClick={() => {
                if (!event?.is_disabled) setCart(event);
                else setError("Entries are full!");
              }}
              color={!event?.is_disabled ? "primary" : "secondary"}
            >
              Participate
            </Button>
          </Grid>
