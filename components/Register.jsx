    ...
    return(
        <>
            <Dialog
                ...
                // onBackdropClick={() => notify('Please Complete the Sign Up Process')}
            ...
            >
                ...
                <form action="">
                    ...
                    <small>*The above data cannot be changed once submitted. All spam entries will be disqualified.</small>
                    <br/>
